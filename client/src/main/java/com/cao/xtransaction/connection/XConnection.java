package com.cao.xtransaction.connection;
...
public class XConnection implements Connection {
    ...
    private XTransaction lbTransaction;

    public XConnection(Connection connection, XTransaction lbTransaction) {
    ...
    public void commit() throws SQLException {
        ...
        System.out.println("开启异步等待提交任务");
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    System.out.println("s会务中间状态");
                    lbTransaction.getTask().waitTask();
                    System.out.println("continue local transaction");
